...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($roll)) { array_push($errors, "roll number is required"); }
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO users (roll,username, email,department,gender,year_of_study, password) 
    VALUES('$roll','$username', '$email','$department','$gender', '$year','$password')";
